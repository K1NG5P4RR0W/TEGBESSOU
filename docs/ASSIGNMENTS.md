...
|---|---|---|---|
| **K1NG5P4RR0W** | CŒUR — exécution + RECON | E0 → E1 → E3 | Chemin critique, touche sécurité/archi : revient au mainteneur principal |
...
2. **Revue croisée obligatoire.** Front relit Back et inversement quand c'est possible ; K1NG5P4RR0W relit les PR qui touchent les gardes ou l'audit.
3. **Le cœur (E) ne code pas avant E0.** La conception de l'isolation d'exécution se fait à deux (K1NG5P4RR0W + relecteur) — c'est le seul endroit où une erreur a un vrai coût de sécurité.
